...
class Trainer:
    ...
    def train(self):
        cfg = self.cfg
        n_iters = cfg_get(cfg, "training.iterations", 40000)
        ...
        densify_until_iter = cfg_get(cfg, "densify.until_iter", 40000)
        ...
        max_anisotropy = cfg_get(cfg, "densify.max_anisotropy", 6.0)
